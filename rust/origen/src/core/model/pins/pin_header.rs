...
impl PinHeader {
    pub fn new(model_id: usize, id: usize, name: &str, pins: Vec<String>) -> Self {
        return Self {
            model_id: model_id,
            id: id,
...
impl Dut {
    pub fn create_pin_header(
        ...
        self.pin_headers
            .push(model.register_pin_header(id, name, pins)?);
        Ok(&self.pin_headers[id])
    }
}

impl Model {
    pub fn register_pin_header(
        &mut self,
        pid: usize,
        name: &str,
