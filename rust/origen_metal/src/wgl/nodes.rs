...
pub enum WGL {
    Root,
    WaveformProgram(String),
    WaveformParameters(Option<bool>, String), // (is_freerunningclock, domain_name)
    Integer(i64),
    Float(f64),
    String(String),
    Unknown,
    ...
    Divide,
    Power,
    Constant(f64, Option<wgl::Scale>, Option<wgl::EqUnit>),
    MinMax,
    Min,
    Max,
    EquationDefaults,
