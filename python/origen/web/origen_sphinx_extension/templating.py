...
def process_docstring(app, what, name, obj, options, lines):
  ...
  try:
    ...
    m = getattr(e, 'message', repr(e))
    raise type(e)(f"Exception occurred processing the docstring for {name} of doc-type '{what}' (from {app.env.docname}) {': ' + m if m else ''}") from e
  _lines += "\n"
  lines.clear()
  lines += _lines.split("\n")
