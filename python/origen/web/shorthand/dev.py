...
m = origen.helpers.mod_from_file(origen.web.source_dir.joinpath('_conf/shorthand.py'))
...
shorthand_dev_defs = {
  ...
  'refs': {
    'templating': ('Template Helpers', f'{guides_root}:Usage In Templating'),
    'categories': f'{guides_root}:Categories',
    'config_var': ('shorthand_defs config variable', f'{guides_root}:Basic Usage'),
    'conf_var': ('shorthand_defs config variable', f'{guides_root}:Basic Usage'),
    'config_keys': ('shorthand_defs config keys', f'{guides_root}:Other Configuration Keys'),
    'multidefs': (
      'Using Multiple Shorthand Definitions',
      f'{guides_root}:Using Multiple Shorthand Definitions'
    ),
    'namespaces': f'{guides_root}:Definition Namespaces',
    'project_namespace': f'{guides_root}:Project Namespace',
