...
extlinks = {
  ...
  'sphinx_build_cmd': ('https://www.sphinx-doc.org/en/master/man/sphinx-build.html%s', ''),
  ...
  'sphinx_core_events': ('https://www.sphinx-doc.org/en/master/extdev/appapi.html#sphinx-core-events%s', ''),
  ...
  'sphinx_nitpicky': ('https://www.sphinx-doc.org/en/master/usage/configuration.html#confval-nitpicky%s', ''),
  'sphinx_xrefing': ('https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#cross-referencing-arbitrary-locations%s', ''),
  'sphinx_ref_role': ('https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#role-ref%s', ''),
  'sphinx_doc_role': ('https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#role-doc%s', ''),
  'sphinx_python_domain': ('https://www.sphinx-doc.org/en/master/usage/restructuredtext/domains.html#the-python-domain%s', ''),
  ...
  'rst_substitutions': ('https://docutils.sourceforge.io/docs/ref/rst/restructuredtext.html#substitution-definitions%s', ''),
  'rst_include_directive': ('https://docutils.sourceforge.io/docs/ref/rst/directives.html#include%s', ''),
  ...
  'autosectionlabel_home': ('https://www.sphinx-doc.org/en/master/usage/extensions/autosectionlabel.html%s', ''),
  'autosectionlabel_prefix_document_config': ('https://www.sphinx-doc.org/en/master/usage/extensions/autosectionlabel.html#confval-autosectionlabel_prefix_document%s', ''),
  'napoleon_home': ('https://www.sphinx-doc.org/en/master/usage/extensions/napoleon.html%s', ''),
  'google_docstring_spec': ('https://google.github.io/styleguide/pyguide.html%s', ''),
  'numpy_docstring_spec': ('https://numpydoc.readthedocs.io/en/latest/format.html#docstring-standard%s', ''),
  'inheritance_diagram_home': ('https://www.sphinx-doc.org/en/master/usage/extensions/inheritance.html%s', ''),
  'inheritance_diagram_example': ('https://www.sphinx-doc.org/en/master/usage/extensions/inheritance.html#examples%s', ''),
  'graphviz_ext_home': ('https://www.sphinx-doc.org/en/master/usage/extensions/graphviz.html#module-sphinx.ext.graphviz%s', ''),
  'graphviz_home': ('https://graphviz.org/%s', ''),
  'graphviz_download': ('https://www.graphviz.org/download/%s', ''),
  'extlinks_home': ('https://www.sphinx-doc.org/en/master/usage/extensions/extlinks.html%s', ''),
  'extlinks_config_var': ('https://www.sphinx-doc.org/en/master/usage/extensions/extlinks.html#confval-extlinks%s', ''),
  ...
  'docstring_sig_override_so': ('https://stackoverflow.com/questions/12082570/override-function-declaration-in-autodoc-for-sphinx/12087750#12087750%s', ''),
  'docstring_sig_override_cv': ('https://www.sphinx-doc.org/en/master/usage/extensions/autodoc.html#confval-autodoc_docstring_signature%s', ''),
  'docstrings_guide_tc': ('https://thomas-cokelaer.info/tutorials/sphinx/docstring_python.html%s', ''),
  ...
  'origen_issues_bugs': ('https://github.com/Origen-SDK/o2/issues?q=is:open+is:issue+label:bug%s', ''),
  ...
  'origen_core_init_src': (f'https://github.com/Origen-SDK/o2/blob/{core_github_branch}/python/origen/__init__.py%s', ''),
  'origen_core_ose_src': (f'https://github.com/Origen-SDK/o2/blob/{core_github_branch}/python/origen/web/origen_sphinx_extension/__init__.py%s', ''),
  ...
  'origen_core_guides_conf_src': (f'https://github.com/Origen-SDK/o2/blob/{core_github_branch}/python/web/source/conf.py%s', ''),
  'origen_core_shorthand_init_src': (f'https://github.com/Origen-SDK/o2/blob/{core_github_branch}/python/origen/web/shorthand/__init__.py%s', ''),
  'origen_core_web_init_src': (f'https://github.com/Origen-SDK/o2/blob/{core_github_branch}/python/origen/web/__init__.py%s', ''),
  'origen_app_shorthand_defs_src': (f'https://github.com/Origen-SDK/o2/blob/{core_github_branch}/python/web/source/_conf/shorthand.py%s', ''),
