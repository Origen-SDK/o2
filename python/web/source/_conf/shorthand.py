...
origen_shorthand_defs = {
    'extlinks': {
        ...
        'so_tag': ('Origen stack overflow', 'origen_so_home'),
        'jinja':
        'jinja_home',
        ...
        'sphinx_config_vars':
        ('Sphinx configuration variables', 'sphinx_conf'),
        ...
        'inheritance_diagram':
        ('inheritance diagram', 'inheritance_diagram_home'),
        'napoleon':
        'napoleon_home',
        'extlinks':
        'extlinks_home',
        ...
        ('RST include directive', 'rst_include_directive'),
        'docstrings':
        'docstrings_intro',
        'docstring':
        'docstrings_intro',
        'google_docstring_spec': ('Google Docstring Spec',
                                  'google_docstring_spec'),
        'numpy_docstring_spec': ('Numpy Docstring Spec',
                                 'numpy_docstring_spec'),
        'autodoc': ('Autodoc', 'autodoc_home'),
        'autoapi': ('AutoAPI', 'autoapi_home'),
        'Autodoc': ('Autodoc', 'autodoc_home'),
        'Autoapi': ('AutoAPI', 'autoapi_home'),
        'py_domain': ('Sphinx Python Domain', 'sphinx_python_domain'),
        ...
        'ldap': {
            ...
            'invalid_credentials':
            ('LDAP invalid credential', 'ldap_invalid_credentials'),
        ...
        'test_app_origen_config': ('Origen\'s test app config',
    ...
    'shorthand_defs': {
        ...
        ('Shorthand referencing', 'shorthand~basic_usage'),
    },
    'docs': {
        'guides': ('Guides', 'index'),
        'dev_install':
        ('development installation guide', 'guides/developers/installation'),
        'origen_api': ('Origen API', f'{autoapi_root}/origen/origen'),
        '_origen_api': ('_origen API', f"{autoapi_root}/_origen/_origen"),
        'ose_api':
        ('Origen Sphinx Extension API',
         f'{autoapi_root}/origen/origen.web.origen_sphinx_extension'),
        'origen_web_api':
        ('origen.web API', f'{autoapi_root}/origen/origen.web'),
        'documenting': {
            'rustdoc': (
        ...
        'rustdoc_api':
        ('RustDoc API', f'{autoapi_root}/origen/origen.web.rustdoc'),
    },
    'refs': {
        'origen_app':
        ('Origen app',
        ...
        'origen_plugins':
        ('Origen plugins', f'{plugins_root}/introduction:Introduction'),
        'origen_cli':
        ('Origen CLI', f'{getting_started_root}/core_concepts:The Origen CLI'),
        'timesets': ('Timesets', f'{device_modeling_root}/timesets:Timesets'),
        'pins': ('Pins', f'{device_modeling_root}/pins:Pins'),
        'bits': ('Bits', f'{device_modeling_root}/bits_and_registers:Bits'),
        'registers':
        ('Registers', f'{device_modeling_root}/bits_and_registers:Registers'),
        'logger': ('logger', f'{utility_root}/logger:Logger'),
        ...
        'prog-gen': {
            'comments':
            'guides/testers/program_generation/program_api:Comments',
        },
        'pat-gen': {
            'comments':
            'guides/testers/pattern_generation/pattern_api:Comments',
        },
        'developers': {
            'home': ('developers', 'guides/developers:Developers'),
            'doc_gen_arch': (
        ...
        'documenting': {
            'introduction': ('Documenting: Introduction',
                             f"{doc_root}/introduction:Introduction"),
            'core_concepts': ('Documenting: Core Concept',
            ...
            'shorthand':
            ('Shorthand', f'{doc_root}/shorthand_ext:The Shorthand Extension'),
            'origen_shorthand_defs':
...
origen_shorthand_defs['refs']['patgen'] = origen_shorthand_defs['refs'][
    'pat-gen']
origen_shorthand_defs['refs']['proggen'] = origen_shorthand_defs['refs'][
    'prog-gen']
